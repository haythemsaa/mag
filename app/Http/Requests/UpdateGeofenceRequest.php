...
class UpdateGeofenceRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'type' => 'sometimes|required|in:authorized,forbidden,client_site,depot,parking,service_area,delivery_zone,restricted',
            'shape' => 'sometimes|required|in:circle,polygon',
